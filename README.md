...
Autors: [Leandro Linares de los Reyes]
...
En aquesta activitat s’ha desplegat la proposta definitiva de pàgina web corporativa de FoodLogistic, escollida després del procés de consens de la T08.

L’objectiu és presentar una única solució web professional, clara i funcional davant els responsables de FoodLogistic, preparada per substituir la seva pàgina actual.

## Web definitiva

[**Veure la web**](https://github.com/classesSMX2n/web-projecte7-Nitroxi-1)
